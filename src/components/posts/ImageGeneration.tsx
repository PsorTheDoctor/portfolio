...
export const ImageGeneration = () => (
  <Wrapper>
    ...
    for them giving us DALL-E 2 followed by Google's Imagen, Parti and Stability AI's Stable Diffusion.</p>

    <p>To avoid explicit usage of the model generation of some topics including 
    realistic human faces has been prohibited at the early stages of deployment.
    Anyway, I've managed to create the variations
